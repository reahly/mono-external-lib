...
static auto eft_hard_settings = mono::find_class( "Assembly-CSharp", "EFTHardSettings");
printf( "[EFTHardSettings] -> %p", eft_hard_settings->->get_vtable( mono::get_root_domain( ) )->get_static_field_data( ) );
```
